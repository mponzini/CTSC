---
title: "CTSC Template Short Vignette"
author: "Matt Ponzini"
date: "`r Sys.Date()`"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{CTSC Template Short Vignette}
...
The CTSC Template Short provides a skeleton for project documentation and report generation. The template should make it easier to follow reproducible research guidelines and standardize the output for CTSC projects conducted using RStudio.  
...
```{asis, echo=internal}
Generic chunk to include additional notes/doucemtnation that you do not want to
send to the client.
```
