...
library("ggplot2")
# arsenal: create summary tables
if(!require("arsenal")) install.packages('arsenal')
library("arsenal")
# openxlsx: import XLSX files without java dependency
if(!require("openxlsx")) install.packages('openxlsx')
library("openxlsx")
# readxl: import xls files
if(!require("readxl")) install.packages('readxl')
library("readxl")
# DT: customize tables
if(!require("DT")) install.packages('DT')
library("DT")
# svglite: convert plot to svg data
if(!require("svglite")) install.packages('svglite')
library("svglite")
# slickR: create figure carousel
if(!require("slickR")) install.packages('slickR')
library("slickR")
# haven: import sas, spss, stata data files
